...
public class ProyeccionFileCab {
	...
	private List<ProyeccionFileDet> detalle;
	...
	public List<ProyeccionFileDet> getDetalle() {
		return detalle;
	}

	public void setDetalle(List<ProyeccionFileDet> detalle) {
