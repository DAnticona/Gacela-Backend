...
public class FileMTC1R999DaoImpl {
	...
	public String registraFile(FileCabMTC1R999DTO fileCab, String token) throws SQLException {
		...
		ps1.setString(1, fileCab.getNoFile());
		ps1.setDate(2, new java.sql.Date(fileCab.getFeCargaFile().getTime()));
		ps1.setString(3, fileCab.getFgActi());
		...
		for (FileDetMTC1R999DTO detalle : fileCab.getDetalle()) {

			// System.out.println(coFile);
			// System.out.println(detalle.getIdItem());
			// System.out.println(detalle.getNave());
