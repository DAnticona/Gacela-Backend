...
public class LoginControlador {
	...
	public boolean estaConectado(Login login) {
		...
		token.generaToken(login);
		
		Globales.tokens.add(token.getToken());
	...
	public Usuario obtenerUsuarioConectado(Login login) {
		...
		if(usuario != null) {
			...
			if(token.getToken() != null) {
				...
				((Log)Globales.variablesGlobales.get("log")).setMensaje("ERROR AL GENERAR EL TOKEN PARA EL USUARIO: " + login.getNoUsua());
